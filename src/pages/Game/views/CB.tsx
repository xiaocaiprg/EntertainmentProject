...
import { GameInfo } from '../components/CB/GameInfo';
import { GameRule } from '../components/CB/GameRule';
import { GameStatusModal } from '../components/CB/GameStatusModal';
import { useCBGameLogic } from '../hooks/useCBGameLogic';
...
import { updateGameStats } from '../utils/gameCBLogic';
import { convertToHistoryRecords } from '../utils/historyHelper';

export interface CBGameProps {
