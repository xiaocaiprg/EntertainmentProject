export const zh = {
  ...
  fixedDeposits: {
    ...
    depositName: '定存名称',
    depositAmount: '积分数量',
    namePlaceholder: '请输入定存名称',
    amountPlaceholder: '请输入积分数量',
    confirmCreate: '确认创建',
    payPasswordTitle: '输入支付密码',
    nameRequired: '请输入定存名称',
    amountRequired: '请输入积分数量',
    amountInvalid: '积分必须大于100',
    amountExceedsAvailable: '定存积分不能超过可用积分',
    availablePoints: '可用积分',
    createSuccess: '定存创建成功',
    terminate: '支取',
    confirmTerminate: '确认支取',
    confirmTerminateMessage: '确定要支取该定存吗？此操作不可撤销。',
  ...
  pointsTransfer: {
    ...
    groupAccountPlaceholder: '请输入集团账号',
  ...
  creditTransfer: {
    ...
    companyAccountPlaceholder: '请输入公司账号',
    groupAccountPlaceholder: '请输入集团账号',
    amountPlaceholder: '请输入转账额度数量',
    descriptionPlaceholder: '请输入备注信息（可选）',
    invalidNumber: '请输入有效的数字',
    integerOnly: '只能输入整数',
    moreThanZero: '额度必须大于0',
    notEnoughCredit: '额度不足',
    confirmTitle: '确认转账',
    success: '转账成功',
    successMessage: '已成功转账{{amount}}额度',
    payPassword: '请输入支付密码',
    receiverCode: '接收方编码',
    receiverName: '接收方名称',
    transferAmount: '转账数量',
  ...
  myGames: {
    ...
    targeted: '定向',
    convertToPublic: '转公开',
    convertToPublicTitle: '确认转为公开募资',
    convertToPublicMessage: '确定要将此挑战从定向募资转为公开募资吗？转换后将无法撤销。',
    confirmConvert: '确认转换',
    convertSuccess: '已成功转为公开募资',
